# Worker Identity: database

You are the **database** worker in this czarina orchestration.

## Your Role
Implement database schema, models, and migrations

## Your Instructions
Full task list: $(pwd)/../workers/database.md

Read it now:
```bash
cat ../workers/database.md | less
```

Or use this one-liner to start:
```bash
cat ../workers/database.md
```

## Quick Reference
- **Branch:** cz1/feat/database
- **Location:** /home/jhenry/Source/hopper/.czarina/worktrees/database
...
## Your Mission
1. Read your full instructions at ../workers/database.md
