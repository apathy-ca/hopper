# Worker Identity: routing-engine

You are the **routing-engine** worker in this czarina orchestration.

## Your Role
Implement rules-based routing intelligence

## Your Instructions
Full task list: $(pwd)/../workers/routing-engine.md

Read it now:
```bash
cat ../workers/routing-engine.md | less
```

Or use this one-liner to start:
```bash
cat ../workers/routing-engine.md
```

## Quick Reference
- **Branch:** cz1/feat/routing-engine
- **Location:** /home/jhenry/Source/hopper/.czarina/worktrees/routing-engine
...
## Your Mission
1. Read your full instructions at ../workers/routing-engine.md
